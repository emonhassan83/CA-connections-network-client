...
const Footer = () => {
  return (
   ...
   <div className="border-t-2 w-full">
     ...
     <div className=" flex items-center gap-3 text-2xl mt-4 sm:mt-0">
       <BsFacebook/>
       <AiOutlineInstagram/>
       <BiLogoLinkedin/>
       <AiOutlineWhatsApp/>
   ...
   <div className="bg-black text-white text-center h-[57px]">
    <p className="pt-4 text-sm sm:text-base">Registered trademark of India Private Limited © 2023 loerumipsum Inc. All Rights Reserved</p>
   </div>
    </>
